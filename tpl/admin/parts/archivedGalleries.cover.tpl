	...
	<div class="col-md-9">
		<div>
			...
			<fieldset>
				...
				<input type="button" class="btn btn-success btn-sm restoreGalleryButton" value="{__RESTORE__}" />
				<button type="button" class="btn btn-danger btn-sm deleteGalleryButton">
